...
- Buka website super.franky.yyy.com/public.comatau www.super.franky.yyy.com/public dengan lynx
...
## 🏷️ Soal 12: Tidak hanya itu, Luffy juga menyiapkan error file 404.html pada folder /error untuk mengganti error kode pada apache .

### ✍️ Langkah-Langkah Pengerjaan:

#### 🖥️ Node Skypie

- Edit config super.franky.e16.com di sites-available dengan menambah rules untuk ErrorDocument 404 yang mengarah ke directory /error/404.html
...
- Buka website super.franky.yyy.com www.super.franky.yyy.com dengan url directory yang salah dengan lynx

```
lynx http://super.franky.e16.com/apaajadeh
lynx http://www.super.franky.e16.com/apaajadeh
```

![image](https://user-images.githubusercontent.com/49280352/139536840-eb14b639-9924-4288-9ca9-e4e1a1bfa567.png)

Jika hasil seperti gambar diatas maka sudah berhasil.

## 🏷️ Soal 13: Luffy juga meminta Nami untuk dibuatkan konfigurasi virtual host. Virtual host ini bertujuan untuk dapat mengakses file asset www.super.franky.yyy.com/public/js menjadi www.super.franky.yyy.com/js. 

### ✍️ Langkah-Langkah Pengerjaan:

#### 🖥️ Node Skypie

- Edit config super.franky.e16.com di sites-available dengan menambah alias untuk "/var/www/super.franky.e16.com/public/js" menjadi "/js"
...
<VirtualHost *:80>
	...
	<Directory /var/www/super.franky.e16.com/public/images>
                Options -Indexes
        </Directory>
...
- Buka website super.franky.yyy.com/js www.super.franky.yyy.com/js dengan lynx

```
lynx http://super.franky.e16.com/js
lynx http://www.super.franky.e16.com/js
```

![image](https://user-images.githubusercontent.com/49280352/139537089-840eb831-d0a5-4d56-bc7a-abab91ceae0e.png)
...
- Buat Config untuk www.general.mecha.franky.e16.com:15000 dan www.general.mecha.franky.e16.com-15500 dengan setting port di sebelah "VirtualHost *:"

```
cd /etc/apache2/sites-available
cp 000-default.conf www.general.mecha.franky.e16.com-15000.conf
...
```
cp 000-default.conf www.general.mecha.franky.e16.com-15500.conf
...
- Enable config dengan a2ensite dan enable port di ports.conf

```
cd /etc/apache2/sites-available
a2ensite www.general.mecha.franky.e16.com-15000.conf
a2ensite www.general.mecha.franky.e16.com-15500.conf
...
- Copy isi website general.mecha ke dalam /var/www/general.mecha.franky.e16.com

```
cd
cp -r general.mecha.franky /var/www/general.mecha.franky.e16.com
```
